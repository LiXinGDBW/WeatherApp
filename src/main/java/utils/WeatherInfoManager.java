...
// // Jsoup.connect(url).get()：模拟浏览器发送 HTTP 请求。
// // 返回一个 Document 对象，表示 HTML 页面内容
// Document doc = Jsoup.connect(url).get();

// // 使用 CSS 选择器提取温度和天气状况元素，查找页面中的第一个匹配元素
// Element temperatureDiv = doc.selectFirst("div.h15listtem.h15k");
// Element weatherElement = doc
// .selectFirst("div.h15listbody > ul > li:nth-child(1) > div.h15tiao >
// div:nth-child(2) > p");
...
// System.out.println("城市删除成功！共删除 " + (weatherDeletedRows + cityCodeDeletedRows)
// + " 条记录");
// } else {
